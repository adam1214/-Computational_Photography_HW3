...
if __name__ == '__main__':
    ...
    motion_shifts = [(0, 0), (0.22, 0.34), (-0.31, 0.18), (0.25, -0.29), (-0.36, -0.21), (-0.1, -0.1)]
    img_tests = []
    gau_rgbs = []
    ...
    imageio.imwrite('./result/zebra_test_six.png', img_out)
    # check answer
    img_urs_path = './result/zebra_test_six.png'
